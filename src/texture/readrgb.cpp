...
static ImageRec *ImageOpen(FILE *fileName)
...
//unsigned *read_texture(char const *name, int *width, int *height, int *components) 
unsigned *read_texture(FILE *name, unsigned int *width, unsigned int *height, int *components) 
{
   unsigned *base, *lptr;
